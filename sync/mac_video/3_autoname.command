...
echo " ※ 원본번호(IMG_9560)를 뒤에 붙일지는 «다음 화면» 에서 고릅니다."
echo "    붙이면 →  공수2 부분집합 p127 260727 IMG_9560"
echo ""
printf " 번호 [1] → "
read -r STYLE
[ -z "${STYLE:-}" ] && STYLE=1
...
echo ""
echo " ★ 원본번호(IMG_9560)를 이름 끝에 붙일까요?"
echo ""
echo "   y → 공수2 부분집합 p127 260727 IMG_9560"
echo "        원본 폴더(다운로드 · 강의영상원본)에 권합니다."
echo "        편집본을 보고 어느 원본에서 나왔는지 찾을 수 있습니다."
echo ""
echo "   n → 공수2 부분집합 p127 260727"
echo "        유튜브에 올릴 편집본(강의편집)에 권합니다."
echo "        파일명이 그대로 유튜브 제목이 되므로 깔끔합니다."
echo ""
printf " 붙이기 [n] → "
read -r RAWID
